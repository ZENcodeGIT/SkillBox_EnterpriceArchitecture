...
2.	Руководство/Собственник: обеспечи ьтпривление и заинетерсованность клинетской базы за счет реализации новых треобваний
3.	Заказчик в компании (маркетинг): повысить количество пользователей, повысить удвовлетворенность пользователей, обеспечить возвращаемость, увеличить время нахождения в приложении, увеличить продажи
