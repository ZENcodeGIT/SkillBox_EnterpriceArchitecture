...
4.	Работа мобюильных приложений в ОС  Android 7.0 – 12.0/ iOS 9.0- 16.0
...
4) потребность в поддержке микросервисной архитектуры (команда разработчиков уже в штате)
5) 
